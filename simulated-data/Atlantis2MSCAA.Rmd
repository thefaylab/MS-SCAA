...
# total catch, vector for each species
TotClist <- named_group_split(mskeyrun::simCatchIndex %>% select(Name, year, value), Name) %>%
  map("value")
# need to order by sp.order

# weight at age, years in rows, ages in columns
