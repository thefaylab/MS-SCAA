...
Similar to Hydra, MSCAA requires .dat and .pin files as inputs. Kiersten's file `[9Species_Input_MspModel.R](https://github.com/thefaylab/MS-SCAA/blob/master/9Species/R.programs.Inputs/9Species_Input_MspModel.R)` outlines the steps for creating these files and is used here as much as possible.
